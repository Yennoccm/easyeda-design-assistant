...
This forces EasyEDA to fetch the latest footprint data from the server for
every component. After this step, Footprint Verification shows PAD info
populated and pin-to-pad matching works.
